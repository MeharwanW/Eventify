...
import {
  BiSolidDashboard, BiSolidCalendar, BiGroup, BiDollarCircle,
  BiStore, BiMessageDots, BiAnalyse, BiCalendarCheck, BiCog, BiLogOut
} from 'react-icons/bi';
                ...
                <div>
                  <form onSubmit={handleFormSubmit} className='flexColCenter eventForm'>
                    ...
                    <div className='eventFormField paddings flexCenter'>
                      ...
                      <button className='button margin' onClick={() => { setShowAddEventForm(false) }}>Close</button>
                    </div>
                  </form>
                </div>
              </div>
